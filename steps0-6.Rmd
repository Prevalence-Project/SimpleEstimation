...
step1_results <- results_data4 %>% 
  ...
  filter(Year != "2020") |> 
  select(Community, Sex, Age, Year, iso_norm, lambda, od_deaths, est_num_untreated_oud) |> 
...
#saveRDS(step5_results, "Results/step5_results.rds")
```
...
step5_results |> 
  ...
  summarise(
    num_overall_oud = sum(prop_overall_oud*Population),
    Population = sum(Population),
    #estimation 
    aggregated_prop_oud = num_overall_oud/Population
  ) 
```
